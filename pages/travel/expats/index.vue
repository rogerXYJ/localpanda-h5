...
<style lang="scss">
	...
	.expats {
		...
		.headPhoto {
			...
			opacity: 0.9;
			.headPhoto_bg{
				background: url("https://resource.localpanda.com/content/landingpage/expats/banner.jpg") no-repeat;
				height: 5rem;
		...
		.hotActivity {
			...
			.contentBox {
				...
				.activityPhoto {
					...
					position: relative;
					border-radius: 0.1rem;
					background: url("https://resource.localpanda.com/content/landingpage/expats/MembersSeasonalDeal.jpg") no-repeat;
					background-size: cover;
					background-position: center;
					span {
						position: absolute;
