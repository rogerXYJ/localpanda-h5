<template>
    ...
    <Loading :loadingStatus="loadingStatus"></Loading>
      ...
      <h3>Send My Inquiry</h3>
			<p>If you have questions or needs about any specific tour, we have professional consultants to answer your questions on a 1-1 basis.</p>
		</div>
    ...
    <div class="head" v-if="loadTime && !isInquiry && isWork()">
      <p>Due to internet connection problems, Online Chat is currently offline.<br><br>You can contact us in the following ways:<br>+86 (21) 8018-2090<br>+1 (888) 930-8849 (US toll-free)<br>service@localpanda.com</p>
    </div>
            ...
            .then(
              function(response) {
                if (response.data.succeed) {
                  ...
                  that.$emit('inquiryCallback',{'data':response.data,'email':that.email});
                  that.name = "";
                  that.email = "";
                  that.textInfo = "";
                  that.dateTime = "";
