	...
	export default {
		...
		data(){
			...
			return {
				...
				//搜索默认推荐
				recommend:{
					destination:["Shanghai","Beijing","Xi'an","Guilin","Chengdu","Suzhou","Hangzhou"],
					hot:["Bund","Watertown","Great Wall","Terra-Cotta Warriors","Forbidden City","Li River","Layover Tour","Day trips","Local Food","Dumplings","Landmarks","Short Excursions","Family Friendly","Panda"]
				},
